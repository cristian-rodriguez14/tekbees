...
import org.o7planning.springmvcshoppingcart.dao.impl.ClienteDAOImpl;
import org.o7planning.springmvcshoppingcart.dao.impl.DetalleCompraDAOImpl;
import org.o7planning.springmvcshoppingcart.dao.impl.ProductoDAOImpl;
...
public class ApplicationContextConfig {
    ...
    @Bean(name = "productoDAO")
    public ProductoDAO getProductoDAO() {
        return new ProductoDAOImpl();
    }

    @Bean(name = "detalleCompraDAO")
    public DetalleCompraDAO getDetalleCompraDAO() {
        return new DetalleCompraDAOImpl();
    }
